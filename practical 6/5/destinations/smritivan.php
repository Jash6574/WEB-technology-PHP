...
<div class="tile" style="background-image: url('img/miyawakiplantation4.jpg');" id="myBtntwo">
    <div class="textWrapper" ><h2>Smritivan Earthquake Memorial Museum</h2>
    </div>
  </div>
...
<div id="myModaltwo" class="modaltwo">
  ...
  <!-- modaltwo content -->
  <div class="modaltwo-content">    <a class="close" href="">&times;</a><br><br>

    <h1 style="font-size: 48px;">Smritivan Earthquake Memorial Museum</h1><br>

    <img src="img/miyawakiplantation4.jpg" class="image"/>
    <p>
...
Rethink: 
The Rethink Block imparts us with the knowledge of global disaster response, and preparedness measures through games and interactive activities. Learn about India's vulnerability to natural phenomena, the various natural hazards in different geographical areas, and how we can prepare ourselves. The emotional and psychosocial ramifications of post-disaster management are documented here through interviews and first-person experiences.
<br><br>

Relive: 
How the tremors shook Gujarat, how buildings collapsed and how lives turned to fatalities. With the world's largest simulation experience in state-of-the-art 360-degree surrounding simulations, you will feel the earth slip beneath your feet, and experience the tremors that people felt in the 2001 Earthquake in a realistic manner. It also houses the tree of Smritivan, present inside an infinity room, where you can add paper-made petals to the branches as messages.
<br><br>

Renew: 
This gallery is designed to let the visitors pay their respects to the people who lost their lives in this tragedy and to remember the loved ones they might have lost and keep them in their memories with a light spirit. To commemorate them visitors will light up a digital flame through touch panels which will travel through digital LED walls up to the ceiling and form one united light. It is the highest number of optical fiber sensor-based lighting that has ever been placed in a single location in India. Breathtaking, and a sight to behold!
<br><br>
...
// Get the <span> element that closes the modaltwo
var span = document.getElementsByClassName("close")[0];

// When the user clicks the button, open the modaltwo 
btn.onclick = function() {
  modaltwo.style.display = "block";
}

// When the user clicks on <span> (x), close the modaltwo
span.onclick = function() {
  modaltwo.style.display = "none";
}

// When the user clicks anywhere outside of the modaltwo, close it
