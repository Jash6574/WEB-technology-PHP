...
<div class="header-container" style="background: url(https://wallpapercave.com/wp/wp6587224.jpg)" no-repeat;>
        <section class="header">
            ...
            <nav class="navbar">
                <a href="index.php" style="color:black;font-weight:900">home</a>
...
<div class="festival">
  <table width="100%">
    <tr>
      <td width="50%">Et eirmod lorem dolor dolor invidunt eirmod dolor sadipscing eirmod. Diam consetetur ipsum kasd et sea, no sit ea diam.</td> 
      <td width="50%"><img src="img/shrimadrajchandramorning.jpg" style="width:40%"></td>
    </tr>
    <tr>
      <td><img src="img/shrimadrajchandramorning.jpg" style="width:40%"></td>
      <td>Et eirmod lorem dolor dolor invidunt eirmod dolor sadipscing eirmod. Diam consetetur ipsum kasd et sea, no sit ea diam.</td> 
    </tr>
    <tr>
      <td>Et eirmod lorem dolor dolor invidunt eirmod dolor sadipscing eirmod. Diam consetetur ipsum kasd et sea, no sit ea diam.</td> 
      <td><img src="img/shrimadrajchandramorning.jpg" style="width:40%"></td>
